...
$x_{vv'}^o$ & $\mathcal E \times \mathcal O$ & $\mathbb{Z}^+$ & integer number of times the drone traverses the edge $(v,v')$ in operation $o$. \\
$y_{vv'}^o$ & $\mathcal{E}^{int} \times \mathcal O$ & $\{0, 1\}$ & 1, if vertex $v$ is the edge $(v,v')$ is visited during operation $o$. \\
$\zeta^o$ & $\mathcal O$ & $\{0, 1\}$ & 1, if all vertices are visited before starting operation $o$. \\
