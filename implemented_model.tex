...
\noindent \textbf{Difference:} The paper uses exponential DFJ constraints
(original DP7). The implementation uses MTZ ($u_v^o$), which requires
$O(|\mathcal V'|^2 |\mathcal O|)$ constraints but is manageable for
small instances.
...
Subtours & DFJ (exponential) & MTZ ($u_v^o$, polynomial) \\
